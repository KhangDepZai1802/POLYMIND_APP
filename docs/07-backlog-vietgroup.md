...
- [ ] **1.1 Social ứng viên** — thêm trường link MXH (Facebook, Zalo, TikTok, Instagram, link khác) vào Lead + Candidate; hiển thị nút bấm mở ở trang chi tiết. *(handwritten #12)*
- [ ] **1.2 Highlight đơn hàng theo quốc gia** — badge màu + icon theo nước (Nhật/Hàn/Đài/Sing/Đức…) trong danh sách/thẻ đơn hàng; đánh dấu nổi bật đơn **đang tuyển (mở)**. *(handwritten #11; PDF mục 2)*
- [ ] **1.3 Trường Cha/Mẹ/Người bảo hộ** — thêm vào hồ sơ ứng viên: họ tên, SĐT, quan hệ, CCCD, địa chỉ, nghề nghiệp (tách khỏi "liên hệ khẩn cấp" hiện có). Đây là nền cho cổng phụ huynh sau này. *(handwritten #15; PDF 4A)*
- [ ] **1.4 Hiển thị đơn hàng trực quan hơn** — chuyển ưu tiên sang dạng **thẻ + icon**, bớt chữ (theo định hướng "bỏ list nhiều chữ"). *(PDF mục 2)*
- [ ] **1.5 (tùy chọn) Khung trang "Hướng dẫn sử dụng"** — tạo trang rỗng có cấu trúc để điền nội dung sau. *(handwritten #7)*
